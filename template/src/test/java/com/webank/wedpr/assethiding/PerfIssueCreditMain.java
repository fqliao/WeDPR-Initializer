...
public class PerfIssueCreditMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Executes Perf test for verifying issue credit on blockchain.
        ...
        System.out.println("Start issue credit test，total：" + count);
            ...
            threadPool.execute(
                    new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                issueCreditParams.hiddenAssetExamplePerf.issueCredit(
                                        issueCreditParams.hiddenAssetTableName,
                                        issueCreditParams.issueArgument,
                                        callback);
                            } catch (Exception e) {
