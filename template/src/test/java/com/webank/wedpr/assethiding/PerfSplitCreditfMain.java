...
public class PerfSplitCreditfMain {

    private static AtomicInteger sended = new AtomicInteger(0);

    public static void main(String[] args) throws Exception {
        SplitCreditParams splitCreditParams = PerfHiddenAssetUtils.getSplitCreditParams();

        // Executes Perf test for verifying split credit on blockchain.
            ...
            threadPool.execute(
                    new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                splitCreditParams.hiddenAssetExamplePerf.splitCredit(
                                        splitCreditParams.hiddenAssetTableName,
                                        splitCreditParams.splitRequest,
                                        callback);
                            } catch (Exception e) {
