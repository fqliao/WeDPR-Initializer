...
contract WedprPrecompiled {
    ...
    function anonymousVotingAggregateVoteSumResponse(string systemParameters, string voteRequest, string voteStorage)
        public returns(string blankBallot, string voteStoragePart, string voteStorageSum);
    ...
    function anonymousVotingAggregateDecryptedPartSum(string systemParameters, string decryptRequest, string decryptedResultPartStorage)
        public returns(string counterId, string decryptedResultPartStoragePart, string decryptedResultPartStorageSum);
