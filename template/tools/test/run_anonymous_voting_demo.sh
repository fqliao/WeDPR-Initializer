...
function help(){
    ...
    cat << EOF
Usage:
    -t <voting type>                [Required] Set voteBounded or voteUnbounded.
    -h Help
EOF
...
function run(){
    java -Djdk.tls.namedGroups="secp256k1" -cp "../../apps/*:../../conf/:../../lib/*" com.webank.wedpr.example.anonymousvoting.DemoMain ${type}
}
